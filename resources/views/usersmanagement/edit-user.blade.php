...
@section('template_title')
    Editiere Benutzer {{ Auth::user()->scoutname ? Auth::user()->scoutname : Auth::user()->first_name }}
@endsection

@section('template_linked_css')
    <style type="text/css">
        .btn-save, .pw-change-container {
            display: none;
        }
    </style>
@endsection
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <strong>Editiere Benutzer:</strong> {{ Auth::user()->scoutname ? Auth::user()->scoutname : Auth::user()->first_name }}

                        <a href="/users/{{$user->id}}" class="btn btn-primary btn-xs pull-right" style="margin-left: 1em;">
                            <i class="fa fa-fw fa-mail-reply" aria-hidden="true"></i>Zurück <span class="hidden-xs">zu Benutzer</span>
                        </a>

                        <a href="/users" class="btn btn-info btn-xs pull-right">
                            <i class="fa fa-fw fa-mail-reply" aria-hidden="true"></i><span class="hidden-xs">Zurück zu </span>Benutzern
                        </a>
                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('scoutname') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('scoutname', old('scoutname'), array('id' => 'scoutname', 'class' => 'form-control', 'placeholder' => trans('forms.ph-username'))) !!}
