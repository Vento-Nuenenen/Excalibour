              ...
              <div class="form-group has-feedback row {{ $errors->has('scoutname') ? ' has-error ' : '' }}">
                ...
                <div class="col-md-9">
                  <div class="input-group">
                    {!! Form::text('scoutname', NULL, array('id' => 'scoutname', 'class' => 'form-control', 'placeholder' => trans('forms.create_user_ph_username'))) !!}
                    <label class="input-group-addon" for="scoutname"><i class="fa fa-fw {{ trans('forms.create_user_icon_username') }}" aria-hidden="true"></i></label>
                  </div>
