        ...
        <div class="card EditParticipant mb-3">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent=".EditParticipant">
                <div class="card-body table-responsive">
                    {!! Form::open(array('route' => ['update-fields',$fields->id], 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group has-feedback row {{ $errors->has('field_name') ? ' has-error ' : '' }}">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                {!! Form::text('field_name', old('field_name', $fields->name ?? null), array('id' => 'field_name', 'class' => 'form-control', 'placeholder' => 'Postenname')) !!}
                    ...
                    <div class="form-group has-feedback row {{ $errors->has('field_description') ? ' has-error ' : '' }}">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                {!! Form::text('field_description', old('field_description', $fields->description ?? null), array('id' => 'field_description', 'class' => 'form-control', 'placeholder' => 'Postenbeschreibung')) !!}
                                <div class="input-group-append">
                    ...
                    <div class="form-group has-feedback row {{ $errors->has('field_points') ? ' has-error ' : '' }}">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                {!! Form::number('field_points', old('field_points', $fields->MAX_POINTS ?? null), array('id' => 'field_points', 'class' => 'form-control', 'placeholder' => 'Maximale Punkte')) !!}
                                <div class="input-group-append">
                    ...
                    {!! Form::button('Posten aktualisieren', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
